    ...
    def analyse(self):
        ...
        for chn in self.process_channels:
            ...
            for tag in ["obj", "clt"]:
                ...
                if tag == "clt" and self.segmentation == "instance":
            ...
            if "clt_results_all_f" in self.results[chn]:

                self.results[chn]["clt_results_all_f"].to_csv(
                    self.data_path / f"clt_{chn}_results_all_f.csv",
                    )
                self.results[chn]["results_stm_avg_f"].to_csv(
                    self.data_path / f"results_{chn}_stm_avg_f.csv",
                    )
                self.results[chn]["results_cnd_avg_f"].to_csv(
                    self.data_path / f"results_{chn}_cnd_avg_f.csv",
                    )
